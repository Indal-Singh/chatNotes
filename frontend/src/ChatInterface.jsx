      ...
      <div className={`w-full md:w-80 bg-[#1a1a1a] border-b md:border-b-0 md:border-r border-[#333] p-6 ${selectedTopic ? 'hidden md:block' : 'block'}`}>
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-2xl font-bold text-teal-300">ChatNotes</h1>
          </div>
          <button 
            onClick={() => setIsAddingTopic(true)}
            className="text-teal-400 hover:bg-[#333] p-2 rounded-full"
          >
            <Plus />
          </button>
        </div>
        ...
        {topics.map(topic => (
          ...
          >
            <div className="flex justify-between items-center">
              <h3 className="font-semibold text-teal-300">{topic.name}</h3>
        ...
        {selectedTopic ? (
          <>
            ...
            <div className="p-6 border-b border-[#333] flex justify-between items-center">
              <h2 className="text-2xl font-bold text-teal-300">{selectedTopic.name}</h2>
